...
int main(void)
{
   ...
   assert(valid_flowstate(test_cont));
   assert(test_cont->position==19);

   free_word_cont(test_cont);

   assert(do_comparison_helper(10.0,10.0,equal));
   assert(do_comparison_helper(0,0,equal));
   assert(!do_comparison_helper(10.0,9.9999,equal));
   assert(do_comparison_helper(10.0,11.0,less));
   assert(!do_comparison_helper(11.0,11.0,less));
   assert(!do_comparison_helper(12.0,11.0,less));

   assert(!do_comparison_helper(10.0,11.0,greater));
   assert(!do_comparison_helper(11.0,11.0,greater));
   assert(do_comparison_helper(12.0,11.0,greater));


   assert(do_comparison_helper(-1.0,-11.0,greater));
   ...
   assert(run_else(test_cont,test_line_cont));
   ...
   assert(run_false(test_cont,test_line_cont));
   assert(test_line_cont->size==1);
   ...
   assert(run_true(test_cont,test_line_cont));
   assert(test_line_cont->size==10);
   assert(test_cont->position==17);
   ...
   assert(run_flowstate(test_cont,test_line_cont));
   assert(test_line_cont->size==0);
   free_line_cont(test_line_cont);
   free_word_cont(test_cont);
